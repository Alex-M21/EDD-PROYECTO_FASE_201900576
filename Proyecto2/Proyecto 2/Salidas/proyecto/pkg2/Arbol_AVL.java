...
public class Arbol_AVL {
    ...
    try {
      ...
      String RutaEntrada = "..\\Proyecto 2\\src\\GraphAVL\\"+entrada+".txt";
      
      String RutaSalida = "..\\Proyecto 2\\src\\GraphAVL\\"+nombre+".jpg";
    ...
    try {   
            String ruta = "..\\Proyecto 2\\src\\GraphAVL\\"+fNombre+".txt";
