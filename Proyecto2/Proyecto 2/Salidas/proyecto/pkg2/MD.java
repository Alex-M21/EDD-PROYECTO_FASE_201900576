...
"splines=false;\n";
    ...
    try {
      ...
      String RutaEntrada = "..\\Proyecto 2\\src\\Matrix\\"+entrada+".txt";
      
      String RutaSalida = "..\\Proyecto 2\\src\\Matrix\\"+nombre+".jpg";
    ...
    try {
      ...
      String GraficarRuta = "C:\\Program Files\\Graphviz\\bin\\dot.exe";
      String RutaEntrada = "..\\Proyecto 2\\src\\Imagenes\\"+entrada+".txt";
      String RutaSalida = "..\\Proyecto 2\\src\\Imagenes\\"+nombre+".jpg";
      String tParametro = "-Tjpg";
      String tOParam = "-o";        
      String[] composicion = new String[5];
      composicion[0] = GraficarRuta;
    ...
    try {   
            String ruta = "..\\Proyecto 2\\src\\Matrix\\"+fNombre+".txt";
    ...
    try {   
            String ruta = "..\\Proyecto 2\\src\\Imagenes\\"+fNombre+".txt";
            String contenido = Data;
            File file = new File(ruta);
            // Si el archivo no existe es creado
            if (!file.exists()) {
